...
begin
  ...
  update public.products set ativo=true, status='published' where id=v_product_id;
  update public.telegram_pending_reviews set status='published', updated_at=now() where id=p_review_id;
