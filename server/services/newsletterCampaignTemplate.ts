...
export function renderNewsletterCampaign(
  ...
  const surfaceBackgroundUrl = buildNewsletterAssetUrl("assets/newsletter/backgrounds/cerberus-surface-dark.png");
...
function addEmailBackgroundAssets(
  html: string,
  assets: { body: string; surface: string; cta: string },
): string {
  const byColor: Record<string, string> = {
    [COLORS.body]: assets.body,
    [COLORS.surface]: assets.surface,
