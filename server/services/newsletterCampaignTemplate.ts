...
export function renderNewsletterCampaign(
  ...
  const htmlCategory = category
    ? `<p class="email-eyebrow" style="margin:0 0 10px;color:#e86b5f;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.4;font-weight:700;letter-spacing:2px;text-transform:uppercase;">${accentEmailText(escapeHtml(category))}</p>`
    : "";
  const htmlNote = note
    ? `<tr><td class="email-pad" bgcolor="#141414" style="padding:0 36px 26px;background:#141414;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#141414" style="border-collapse:collapse;background:#141414;"><tr><td bgcolor="#141414" style="padding:18px 20px;background:#141414;"><p style="margin:0 0 7px;color:#e86b5f;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.4;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">${accentEmailText("Por que selecionamos isso?")}</p><p class="email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.6;">${whiteEmailText(escapeHtml(note))}</p></td></tr></table></td></tr>`
    : "";
  const htmlPrice = `<tr><td class="email-pad" bgcolor="#141414" style="padding:0 36px 26px;background:#141414;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="email-price-card" bgcolor="#141414" style="border-collapse:collapse;background:#141414;border:0;border-radius:8px;"><tr><td bgcolor="#141414" style="padding:20px 22px;background:#141414;"><p style="margin:0 0 8px;color:#e86b5f;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.4;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">${accentEmailText("Preço verificado")}</p><p class="email-price email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:30px;line-height:1.1;font-weight:700;">${whiteEmailText(escapeHtml(verifiedPrice))}</p>${previousPrice ? `<p class="email-white" style="margin:8px 0 0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4;text-decoration:line-through;">${whiteEmailText(escapeHtml(previousPrice))}</p><p style="margin:5px 0 0;color:#e86b5f;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:1.4;font-weight:700;">${accentEmailText(`Economia de ${escapeHtml(savings)}`)}</p>` : ""}</td></tr></table></td></tr>`;
  const htmlLinks = renderSocialLinks(socialLinks);
  const htmlInstitutionalLinks = privacyUrl || termsUrl
    ? `<p class="email-white" style="margin:0 0 13px;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">${privacyUrl ? `<a class="email-white" href="${escapeHtml(privacyUrl)}" target="_blank" rel="noopener" style="color:#ffffff;text-decoration:underline;">${whiteEmailText("Política de privacidade")}</a>` : ""}${privacyUrl && termsUrl ? `<font color="#ffffff" style="color:#ffffff!important;padding:0 8px;">|</font>` : ""}${termsUrl ? `<a class="email-white" href="${escapeHtml(termsUrl)}" target="_blank" rel="noopener" style="color:#ffffff;text-decoration:underline;">${whiteEmailText("Termos e condições")}</a>` : ""}</p>`
    : "";
  const htmlViewLink = viewInBrowserUrl
    ? `<p class="email-white" style="margin:0 0 22px;text-align:right;"><a class="email-white" href="${escapeHtml(viewInBrowserUrl)}" target="_blank" rel="noopener" style="color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.4;text-decoration:underline;">${whiteEmailText("Ver no navegador")}</a></p>`
    : "";
  const htmlUnsubscribe = includeUnsubscribe
    ? `<p class="email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">${whiteEmailText("Você recebeu esta mensagem porque autorizou comunicações de marketing do Cerberus Finds.")} <a class="email-white" href="${escapeHtml(unsubscribeUrl)}" style="color:#ffffff;text-decoration:underline;">${whiteEmailText("Cancelar inscrição")}</a>.</p>`
    : `<p class="email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">${whiteEmailText("Você recebeu esta mensagem porque confirmou sua inscrição no Cerberus Finds.")}</p>`;
  const emailStyles = `<style>:root{color-scheme:dark!important;supported-color-schemes:dark!important;}body{margin:0!important;padding:0!important;background:#0a0a0a!important;color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;}.email-shell,.email-card,.email-pad{background:#141414!important;}.email-card{border:0!important;}.email-price-card{background:#141414!important;border:0!important;}.email-cta-cell{background:#c0392b!important;}table{border-spacing:0;}*,table,td,div{border:0!important;outline:0!important;box-shadow:none!important;}img{border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;}a{text-decoration:none;}@media only screen and (max-width:620px){.email-shell{width:100%!important;}.email-card{border-radius:0!important;}.email-pad{padding-left:20px!important;padding-right:20px!important;}.email-hero-cell{padding-bottom:24px!important;}.email-title{font-size:30px!important;}.email-price{font-size:27px!important;}.email-cta-cell{width:100%!important;}.email-cta-link{display:block!important;padding-top:16px!important;padding-bottom:16px!important;}}@media (prefers-color-scheme:dark){.email-body{background:#0a0a0a!important;}.email-shell,.email-card,.email-pad{background:#141414!important;}.email-card{border:0!important;}.email-price-card{background:#141414!important;border:0!important;}.email-cta-cell{background:#c0392b!important;}.email-title,.email-copy{color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;}}[data-ogsc] .email-body{background:#0a0a0a!important;}[data-ogsc] .email-shell,[data-ogsc] .email-card,[data-ogsc] .email-pad{background:#141414!important;}[data-ogsc] .email-price-card{background:#141414!important;border:0!important;}[data-ogsc] .email-cta-cell{background:#c0392b!important;}[data-ogsc] .email-white,[data-ogsc] .email-title,[data-ogsc] .email-copy,[data-ogsc] .email-price,[data-ogsb] .email-white,[data-ogsb] .email-title,[data-ogsb] .email-copy,[data-ogsb] .email-price{color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;}</style>`;
  const html = protectGmailTextColors(`<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="dark"><meta name="supported-color-schemes" content="dark">${emailStyles}</head><body class="email-body" bgcolor="#0a0a0a" style="margin:0;padding:0;background:#0a0a0a;background-color:#0a0a0a;color:#ffffff;color-scheme:dark;"><span style="display:none!important;max-height:0;max-width:0;overflow:hidden;opacity:0;color:transparent;">${escapeHtml(preheader)}</span><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#0a0a0a" style="width:100%;border-collapse:collapse;background:#0a0a0a;background-color:#0a0a0a;"><tr><td align="center" bgcolor="#0a0a0a" style="padding:24px 12px;background:#0a0a0a;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="email-shell" bgcolor="#141414" style="width:100%;max-width:640px;border-collapse:collapse;background:#141414;background-color:#141414;"><tr><td class="email-card" bgcolor="#141414" style="background:#141414;border:0;border-radius:12px;overflow:hidden;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#141414" style="border-collapse:collapse;background:#141414;"> <tr><td class="email-pad" bgcolor="#141414" style="padding:24px 36px 18px;">${htmlViewLink}${renderNewsletterHeader("Seleção editorial")}</td></tr>${htmlImage}<tr><td class="email-pad" bgcolor="#141414" style="padding:26px 36px 22px;">${htmlCategory}<h1 class="email-title email-white" style="margin:0;color:#ffffff;font-family:Georgia,'Times New Roman',serif;font-size:38px;line-height:1.08;font-weight:700;letter-spacing:-0.5px;">${whiteEmailText(escapeHtml(displayTitle))}</h1></td></tr>${htmlNote}${htmlPrice}<tr><td class="email-pad" bgcolor="#141414" style="padding:0 36px 12px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#141414" style="background:#141414;"><tr><td class="email-cta-cell" align="center" bgcolor="#c0392b" style="border-radius:6px;background:#c0392b;"><a class="email-cta-link email-white" href="${escapeHtml(offerUrl)}" target="_blank" rel="noopener" style="display:block;padding:15px 20px;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.3;font-weight:700;letter-spacing:1.6px;text-decoration:none;text-transform:uppercase;">${whiteEmailText("Ver oferta")}</a></td></tr></table></td></tr><tr><td class="email-pad" bgcolor="#141414" style="padding:0 36px 30px;"><p class="email-copy email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:1.6;text-align:center;">${whiteEmailText(escapeHtml(microcopy))}</p></td></tr><tr><td class="email-pad" bgcolor="#141414" style="padding:24px 36px 8px;text-align:center;"><p style="margin:0 0 10px;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:1.4;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">${whiteEmailText("Sobre esta seleção")}</p><p class="email-copy email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:1.6;">${whiteEmailText("Curadoria direta para encontrar peças e objetos que valem a sua atenção.")}</p></td></tr>${htmlLinks}<tr><td class="email-pad" bgcolor="#141414" style="padding:4px 36px 30px;text-align:center;">${htmlInstitutionalLinks}<p class="email-white" style="margin:0 0 11px;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">${whiteEmailText(escapeHtml(disclosure))}</p>${htmlUnsubscribe}<p class="email-white" style="margin:17px 0 0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:1.4;letter-spacing:1px;">${whiteEmailText("CERBERUS FINDS · CURADORIA INDEPENDENTE")}</p></td></tr></table></td></tr></table></td></tr></table></td></tr></table></body></html>`);
  const text = [
    "CERBERUS FINDS",
...
export function renderNewsletterWelcomeCampaign(
  ...
  const htmlUnsubscribe = includeUnsubscribe
    ? `<p class="email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">${whiteEmailText("Você recebeu esta mensagem porque autorizou comunicações de marketing do Cerberus Finds.")} <a class="email-white" href="${escapeHtml(unsubscribeUrl)}" style="color:#ffffff;text-decoration:underline;">${whiteEmailText("Cancelar inscrição")}</a>.</p>`
    : `<p class="email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">${whiteEmailText("Você recebeu esta mensagem porque confirmou sua inscrição no Cerberus Finds.")}</p>`;
  const emailStyles = `<style>:root{color-scheme:dark!important;supported-color-schemes:dark!important;}body{margin:0!important;padding:0!important;background:#0a0a0a!important;color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;}.email-shell,.email-card,.email-pad{background:#141414!important;}.email-card{border:0!important;}.email-price-card{background:#141414!important;border:0!important;}.email-cta-cell{background:#c0392b!important;}table{border-spacing:0;}a{text-decoration:none;}@media only screen and (max-width:620px){.email-shell{width:100%!important;}.email-card{border-radius:0!important;}.email-pad{padding-left:20px!important;padding-right:20px!important;}.email-title{font-size:32px!important;}.email-copy{font-size:15px!important;}}@media (prefers-color-scheme:dark){.email-body{background:#0a0a0a!important;}.email-shell,.email-card,.email-pad{background:#141414!important;}.email-title,.email-copy{color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;}}[data-ogsc] .email-white,[data-ogsc] .email-title,[data-ogsc] .email-copy,[data-ogsc] .email-price,[data-ogsb] .email-white,[data-ogsb] .email-title,[data-ogsb] .email-copy,[data-ogsb] .email-price{color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;}</style>`;
  const html = protectGmailTextColors(`<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="dark"><meta name="supported-color-schemes" content="dark">${emailStyles}</head><body class="email-body" bgcolor="#0a0a0a" style="margin:0;padding:0;background:#0a0a0a;background-color:#0a0a0a;color:#ffffff;color-scheme:dark;"><span style="display:none!important;max-height:0;max-width:0;overflow:hidden;opacity:0;color:transparent;">${escapeHtml(preheader)}</span><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#0a0a0a" style="width:100%;border-collapse:collapse;background:#0a0a0a;background-color:#0a0a0a;"><tr><td align="center" bgcolor="#0a0a0a" style="padding:24px 12px;background:#0a0a0a;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="email-shell" bgcolor="#141414" style="width:100%;max-width:640px;border-collapse:collapse;background:#141414;background-color:#141414;"><tr><td class="email-card" bgcolor="#141414" style="background:#141414;border:0;border-radius:12px;overflow:hidden;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#141414" style="border-collapse:collapse;background:#141414;"><tr><td class="email-pad" bgcolor="#141414" style="padding:24px 36px 18px;">${htmlViewLink}${renderNewsletterHeader("Curadoria independente")}</td></tr><tr><td class="email-pad" bgcolor="#141414" style="padding:42px 36px 30px;"><p style="margin:0 0 12px;color:#e86b5f;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.4;font-weight:700;letter-spacing:2px;text-transform:uppercase;">${accentEmailText("Boas-vindas")}</p><h1 class="email-title email-white" style="margin:0 0 24px;color:#ffffff;font-family:Georgia,'Times New Roman',serif;font-size:42px;line-height:1.06;font-weight:700;letter-spacing:-0.5px;">${whiteEmailText("Bem-vindo à")}<br>${whiteEmailText("Cerberus Finds")}</h1><p class="email-copy email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.65;">${whiteEmailText("Sua inscrição foi confirmada. A partir de agora, você receberá novas seleções, recomendações e ofertas escolhidas com olhar curatorial.")}</p><p class="email-copy email-white" style="margin:18px 0 0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.65;">${whiteEmailText("A proposta é simples: menos ruído, mais achados que merecem a sua atenção. Quando uma seleção fizer sentido, ela chegará até você com contexto, transparência e um caminho claro para conhecer a oferta.")}</p></td></tr><tr><td class="email-pad" bgcolor="#141414" style="padding:0 36px 28px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#141414" style="border-collapse:collapse;background:#141414;"><tr><td bgcolor="#141414" style="padding:20px;background:#141414;"><p style="margin:0 0 8px;color:#e86b5f;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.4;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">${accentEmailText("O que você pode esperar")}</p><p class="email-copy email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.6;">${whiteEmailText("Seleções editoriais, recomendações e ofertas de parceiros, sempre com identificação da operação, disclosure de afiliado e opção de descadastro individual.")}</p></td></tr></table></td></tr>${htmlLinks}<tr><td class="email-pad" bgcolor="#141414" style="padding:24px 36px 30px;text-align:center;">${htmlInstitutionalLinks}<p class="email-white" style="margin:0 0 11px;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">${whiteEmailText(escapeHtml(disclosure))}</p>${htmlUnsubscribe}<p class="email-white" style="margin:17px 0 0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:1.4;letter-spacing:1px;">${whiteEmailText("CERBERUS FINDS · CURADORIA INDEPENDENTE")}</p></td></tr></table></td></tr></table></td></tr></table></td></tr></table></body></html>`);
  const text = [
    "CERBERUS FINDS",
    "BOAS-VINDAS",
...
function protectGmailTextColors(html: string): string {
  const colors = ["#ffffff", "#c0392b", "#e86b5f"];
...
function renderNewsletterHeader(tagline: string): string {
  return `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#141414" style="width:100%;border-collapse:collapse;border:0;background:#141414;background-color:#141414;"><tr><td align="center" bgcolor="#141414" style="padding:0;background:#141414;background-color:#141414;border:0;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" bgcolor="#141414" style="border-collapse:collapse;background:#141414;background-color:#141414;"><tr><td width="31" height="31" align="center" valign="middle" bgcolor="#c0392b" style="width:31px;height:31px;background:#c0392b;background-color:#c0392b;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:31px;font-weight:700;text-align:center;">${whiteEmailText("CF")}</td><td width="11" bgcolor="#141414" style="width:11px;font-size:0;line-height:0;background:#141414;background-color:#141414;">&nbsp;</td><td valign="middle" bgcolor="#141414" class="email-white" style="background:#141414;background-color:#141414;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:31px;font-weight:700;letter-spacing:2px;white-space:nowrap;">${whiteEmailText("CERBERUS FINDS")}</td></tr></table><p class="email-white" style="margin:12px 0 0;color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:1.4;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;">${whiteEmailText(escapeHtml(tagline))}</p></td></tr></table>`;
}
  ...
  const items = links
    ...
    .map(link => {
      ...
      const item = link.url
        ...
        : `<div aria-label="${escapeHtml(link.label)} ainda não configurado" style="display:inline-block;">${icon}</div>`;
      return `<td valign="middle" style="padding:0 4px;">${item}</td>`;
    })
    .join("");
  if (!items) return "";
  return `<tr><td bgcolor="#141414" style="padding:0 36px 20px;text-align:center;background:#141414;"><p class="email-white" style="margin:0;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.5;letter-spacing:1px;text-transform:uppercase;">${whiteEmailText("Encontre a Cerberus Finds")}</p><table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" bgcolor="#141414" style="margin:10px auto 0;border-collapse:collapse;background:#141414;"><tr>${items}</tr></table></td></tr>`;
}
...
function whiteEmailText(value: string): string {
  return `<font color="#ffffff" style="color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;">${value}</font>`;
}

function accentEmailText(value: string): string {
  return `<font color="#e86b5f" style="color:#e86b5f!important;-webkit-text-fill-color:#e86b5f!important;">${value}</font>`;
}
