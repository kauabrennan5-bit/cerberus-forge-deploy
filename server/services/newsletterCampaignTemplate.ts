...
export function renderNewsletterCampaign(
  ...
  const htmlUnsubscribe = includeUnsubscribe
    ? `<p style="margin:0;color:#9b9085;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">Você recebeu esta mensagem porque autorizou comunicações de marketing do Cerberus Finds. <a href="${escapeHtml(unsubscribeUrl)}" style="color:#e8e1d3;text-decoration:underline;">Cancelar inscrição</a>.</p>`
    : `<p style="margin:0;color:#9b9085;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;">Você recebeu esta mensagem porque confirmou sua inscrição no Cerberus Finds.</p>`;
