...
function buildSequence(cards: ProductCard[], masthead: { mastheadVariant: "A" | "B"; mastheadImageUrl: string | null; mastheadLogoUrl: string | null }): RenderChunk[] {
  return planEditorialBlocks(cards.length).map((block) => {
    ...
    if (block.name === "MICROEDITORIAL") {
      ...
      return { html: microEditorial(eyebrow, copy, block.editorialIndex ?? 0), text: `${eyebrow}: ${copy}`, blockNames: ["MICROEDITORIAL"] };
    }
...
function hero(card: ProductCard): string {
  return `<tr><td class="editorial-block editorial-hero email-collection-feature" bgcolor="${COLORS.surface}" style="padding:0 0 38px;background:${COLORS.surface};background-color:${COLORS.surface};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="${COLORS.surface}" style="width:100%;border-collapse:collapse;background:${COLORS.surface};background-color:${COLORS.surface};"><tr><td class="email-collection-feature-kicker" bgcolor="${COLORS.surface}" style="padding:0 18px 14px;border-top:1px solid ${COLORS.border};background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0;color:${COLORS.accent};font:700 10px/1.35 Arial,Helvetica,sans-serif;letter-spacing:2px;text-transform:uppercase;">${accent("DESTAQUE DA EDIÇÃO")}</p></td></tr><tr><td align="center" bgcolor="${COLORS.surface}" style="padding:0 18px 30px;background:${COLORS.surface};background-color:${COLORS.surface};"><img class="email-collection-image" src="${escapeHtml(card.imageUrl)}" width="520" alt="${escapeHtml(card.alt)}" style="display:block;width:100%;max-width:520px;height:320px;object-fit:contain;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" /></td></tr><tr><td bgcolor="${COLORS.surface}" style="padding:0;background:${COLORS.surface};background-color:${COLORS.surface};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="email-collection-hero-meta" bgcolor="${COLORS.surface}" style="width:100%;border-collapse:collapse;background:${COLORS.surface};background-color:${COLORS.surface};"><tr><td class="email-collection-hero-copy" width="68%" valign="top" bgcolor="${COLORS.surface}" style="width:68%;padding:0 20px 0 0;background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0 0 9px;color:${COLORS.accent};font:700 10px/1.35 Arial,Helvetica,sans-serif;letter-spacing:1.8px;text-transform:uppercase;">${accent(card.category)}</p><h2 style="margin:0;color:${COLORS.white};font:700 31px/1.08 Georgia,'Times New Roman',serif;">${white(card.title)}</h2></td><td class="email-collection-hero-action" width="32%" valign="bottom" align="right" bgcolor="${COLORS.surface}" style="width:32%;padding:0;background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0 0 11px;color:${COLORS.white};font:700 15px/1.35 Arial,Helvetica,sans-serif;">${white(card.price)}</p>${solidCta(card.offerUrl)}</td></tr></table></td></tr></table></td></tr>`;
}

function grid2(cards: ProductCard[]): string {
  const cells = cards.map((card) => `<td class="editorial-grid-cell email-collection-grid-cell" width="50%" valign="top" align="left" bgcolor="${COLORS.surface}" style="width:50%;padding:0 8px 30px;background:${COLORS.surface};background-color:${COLORS.surface};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="email-collection-grid-card" bgcolor="${COLORS.surface}" style="width:100%;border-collapse:collapse;background:${COLORS.surface};background-color:${COLORS.surface};"><tr><td class="email-collection-grid-image-cell" height="164" align="center" bgcolor="${COLORS.surface}" style="height:164px;padding:12px 0 14px;background:${COLORS.surface};background-color:${COLORS.surface};"><img class="email-collection-image" src="${escapeHtml(card.imageUrl)}" width="286" alt="${escapeHtml(card.alt)}" style="display:block;width:100%;max-width:286px;height:142px;object-fit:contain;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" /></td></tr><tr><td class="email-collection-grid-category" height="24" valign="top" bgcolor="${COLORS.surface}" style="height:24px;padding:0 4px;background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0 0 5px;color:${COLORS.accent};font:700 8px/1.35 Arial,Helvetica,sans-serif;letter-spacing:1.3px;text-transform:uppercase;">${accent(card.category)}</p></td></tr><tr><td class="email-collection-grid-title" height="88" valign="top" bgcolor="${COLORS.surface}" style="height:88px;padding:0 4px;background:${COLORS.surface};background-color:${COLORS.surface};"><h3 class="email-collection-title" style="margin:0;color:${COLORS.white};font:700 17px/1.14 Georgia,'Times New Roman',serif;">${white(card.title)}</h3></td></tr><tr><td class="email-collection-grid-price" height="36" valign="top" bgcolor="${COLORS.surface}" style="height:36px;padding:8px 4px 0;background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0;color:${COLORS.white};font:700 13px/1.35 Arial,Helvetica,sans-serif;">${white(card.price)}</p></td></tr><tr><td class="email-collection-grid-action" height="48" valign="top" bgcolor="${COLORS.surface}" style="height:48px;padding:4px 4px 0;background:${COLORS.surface};background-color:${COLORS.surface};">${outlineCta(card.offerUrl)}</td></tr></table></td>`).join("");
...
function horizontal(card: ProductCard): string {
  return `<tr><td class="editorial-block editorial-horizontal" bgcolor="${COLORS.surface}" style="padding:10px 0 34px;background:${COLORS.surface};background-color:${COLORS.surface};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="email-collection-horizontal-table" bgcolor="${COLORS.surface}" style="width:100%;border-collapse:collapse;background:${COLORS.surface};background-color:${COLORS.surface};"><tr><td class="editorial-horizontal-image email-collection-horizontal-image" width="42%" valign="middle" align="center" bgcolor="${COLORS.surface}" style="width:42%;padding:20px 18px 20px 0;background:${COLORS.surface};background-color:${COLORS.surface};"><img class="email-collection-image" src="${escapeHtml(card.imageUrl)}" width="250" alt="${escapeHtml(card.alt)}" style="display:block;width:100%;max-width:250px;height:176px;object-fit:contain;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" /></td><td class="editorial-horizontal-copy email-collection-horizontal-copy" width="58%" valign="middle" bgcolor="${COLORS.surface}" style="width:58%;padding:20px 0 20px 8px;background:${COLORS.surface};background-color:${COLORS.surface};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="email-collection-horizontal-copy-table" bgcolor="${COLORS.surface}" style="width:100%;border-collapse:collapse;background:${COLORS.surface};background-color:${COLORS.surface};"><tr><td height="24" valign="top" bgcolor="${COLORS.surface}" style="height:24px;background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0;color:${COLORS.accent};font:700 8px/1.35 Arial,Helvetica,sans-serif;letter-spacing:1.4px;text-transform:uppercase;">${accent(card.category)}</p></td></tr><tr><td height="78" valign="top" bgcolor="${COLORS.surface}" style="height:78px;background:${COLORS.surface};background-color:${COLORS.surface};"><h3 style="margin:0;color:${COLORS.white};font:700 20px/1.12 Georgia,'Times New Roman',serif;">${white(card.title)}</h3></td></tr><tr><td height="36" valign="top" bgcolor="${COLORS.surface}" style="height:36px;padding-top:8px;background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0;color:${COLORS.white};font:700 13px/1.35 Arial,Helvetica,sans-serif;">${white(card.price)}</p></td></tr><tr><td height="46" valign="top" bgcolor="${COLORS.surface}" style="height:46px;padding-top:4px;background:${COLORS.surface};background-color:${COLORS.surface};">${outlineCta(card.offerUrl)}</td></tr></table></td></tr></table></td></tr>`;
}

function compact(card: ProductCard): string {
  return `<tr><td class="editorial-block editorial-compact" bgcolor="${COLORS.surface}" style="padding:0 0 22px;background:${COLORS.surface};background-color:${COLORS.surface};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="email-collection-compact-table" bgcolor="${COLORS.surface}" style="width:100%;border-collapse:collapse;background:${COLORS.surface};background-color:${COLORS.surface};"><tr><td width="84" height="82" valign="middle" bgcolor="${COLORS.surface}" style="width:84px;height:82px;padding:14px 16px 14px 0;background:${COLORS.surface};background-color:${COLORS.surface};"><img class="email-collection-image" src="${escapeHtml(card.imageUrl)}" width="70" alt="${escapeHtml(card.alt)}" style="display:block;width:70px;height:70px;object-fit:contain;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" /></td><td class="email-collection-compact-copy" height="82" valign="middle" bgcolor="${COLORS.surface}" style="height:82px;padding:14px 0;background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0 0 4px;color:${COLORS.accent};font:700 8px/1.35 Arial,Helvetica,sans-serif;letter-spacing:1.2px;text-transform:uppercase;">${accent(card.category)}</p><h3 style="margin:0;color:${COLORS.white};font:700 16px/1.15 Georgia,'Times New Roman',serif;">${white(card.title)}</h3><p style="margin:6px 0 0;color:${COLORS.white};font:700 12px/1.35 Arial,Helvetica,sans-serif;">${white(card.price)}</p></td><td class="email-collection-compact-action" width="100" height="82" valign="middle" align="right" bgcolor="${COLORS.surface}" style="width:100px;height:82px;padding:14px 0;background:${COLORS.surface};background-color:${COLORS.surface};">${outlineCta(card.offerUrl)}</td></tr></table></td></tr>`;
}

function microEditorial(eyebrow: string, copy: string, editorialIndex: number): string {
  const variant = editorialIndex % 2 === 0 ? "a" : "b";
  const align = variant === "a" ? "left" : "center";
  const innerStyle = variant === "a"
    ? `padding:0 0 0 16px;border-left:2px solid ${COLORS.accent};`
    : `padding:0 14px;border-top:2px solid ${COLORS.accent};border-bottom:1px solid ${COLORS.border};`;
  return `<tr><td class="editorial-block editorial-micro editorial-micro-${variant}" bgcolor="${COLORS.surface}" style="padding:${variant === "a" ? "28px 12px 30px" : "30px 12px 32px"};background:${COLORS.surface};background-color:${COLORS.surface};border-bottom:1px solid ${COLORS.border};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="${COLORS.surface}" style="width:100%;border-collapse:collapse;background:${COLORS.surface};background-color:${COLORS.surface};"><tr><td align="${align}" valign="top" bgcolor="${COLORS.surface}" style="${innerStyle}background:${COLORS.surface};background-color:${COLORS.surface};"><p style="margin:0 0 8px;color:${COLORS.accent};font:700 9px/1.4 Arial,Helvetica,sans-serif;letter-spacing:1.8px;text-transform:uppercase;">${accent(eyebrow)}</p><p style="margin:0;color:${COLORS.ivory};font:700 17px/1.25 Georgia,'Times New Roman',serif;">${ivory(copy)}</p></td></tr></table></td></tr>`;
}
