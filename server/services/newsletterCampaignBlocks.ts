...
function mastheadBlock(headline: string, deck: string, productCount: number, variant: "A" | "B", imageUrl: string | null, logoUrl: string | null): string {
  ...
  const brandMark = logoUrl
    ? `<img class="email-masthead-logo" src="${escapeHtml(logoUrl)}" width="64" height="44" alt="Logo Cerberus Finds" style="display:block;width:64px!important;height:44px!important;object-fit:contain;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" />`
